...
<body>
	<div class="formDiv"><!-- 请求书籍新增的servlet -->
		<form action="/WebBook/book/doadd" method="post">
			<input type="text" name="bno" placeholder="书籍编号"/>
			<br/><br/>
			...
			<br><br/>
			<input type="text" name="remark" placeholder="简介"/>
			<br><br/>
